...
const BREAKPOINTS: Record<string, number[]> = {
    O3: [0, 0.054, 0.070, 0.085, 0.105, 0.200, 0.400, 0.605],
    PM10: [0, 54, 154, 254, 354, 424, 504, 605],
    PM25: [0, 12, 35.4, 55.4, 150.4, 250.4, 350.4, 500.5],
    NO2: [0, 53, 100, 360, 649, 1249, 1649, 2050],
    SO2: [0, 35, 75, 185, 304, 604, 804, 1001],
    CO: [0, 4.4, 9.4, 12.4, 15.4, 30.4, 40.4, 50.5],
}